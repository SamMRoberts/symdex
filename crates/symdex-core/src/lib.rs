...
pub use model::{
    ...
    RustFileIndex, SourceFileIndex, Symbol, SymbolKind,
};
...
pub const CSHARP_PARSER_VERSION: &str = "tree-sitter-c-sharp:0.23.5;symdex-core:0.1.0";
pub const JAVASCRIPT_PARSER_VERSION: &str = "tree-sitter-javascript:0.25.0;symdex-core:0.1.0";
pub const RUST_PARSER_VERSION: &str = "tree-sitter-rust:0.24.2;symdex-core:0.1.0";
pub const TYPESCRIPT_PARSER_VERSION: &str = "tree-sitter-typescript:0.23.2;symdex-core:0.1.0";
