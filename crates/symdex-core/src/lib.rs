...
pub const JSON_CONFIG_PARSER_VERSION: &str = "config-json:symdex-core:0.1.2";
...
pub const TOML_CONFIG_PARSER_VERSION: &str = "config-toml:symdex-core:0.1.2";
pub const TYPESCRIPT_PARSER_VERSION: &str = "tree-sitter-typescript:0.23.2;symdex-core:0.1.2";
pub const YAML_CONFIG_PARSER_VERSION: &str = "config-yaml:symdex-core:0.1.2";
