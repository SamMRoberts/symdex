...
- [ ] Queue quality jobs after successful fast indexing.
- [ ] Exclude secret-blocked and too-large chunks from quality jobs.
- [ ] Mark old jobs stale when a new fast generation supersedes them.
