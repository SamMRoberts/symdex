...
When updating crate versions, MCP behavior, embedding models, or Qdrant collection behavior, re-check the relevant upstream docs and update this file if assumptions changed.
